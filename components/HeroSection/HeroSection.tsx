...
export function HeroSection() {
  return (
    <section data-name="Container-for-hero-section" className="relative mx-auto mt-4 flex h-[700px] md:h-[740px] w-full max-w-[1136px] px-6 lg:mt-11 lg:h-[487px] xl:px-0">
