        ...
        <div className="border-b border-gray-200 bg-white px-6 py-4" dir="rtl">
          <div className="flex items-center gap-4">
            <button
              ...
              className="text-Gray-N700 focus:ring-Primary-P500main font-anjoman-max flex items-center gap-2 rounded-lg bg-gray-100 px-3 py-2 text-sm font-medium transition-colors hover:bg-gray-200 focus:ring-2 focus:ring-offset-2 focus:outline-none"
    ...
    <div className="flex h-screen flex-col bg-white">
      ...
      <div className="border-b border-gray-200 bg-white px-6 py-4" dir="rtl">
        <div className="flex items-start justify-between">
          ...
          <button
            ...
            className="bg-Primary-P500main focus:ring-Primary-P500main font-anjoman-max hover:bg-primary-600 flex items-center gap-2 rounded-lg px-4 py-2 text-sm font-medium text-white transition-colors focus:ring-2 focus:ring-offset-2 focus:outline-none"
            aria-label="سبد سفر"
          >
      ...
      <div className="flex-1 overflow-y-auto">
        ...
        <div className="px-2 py-4">
          <h2 className="text-Gray-N800 font-anjoman-max mb-4 px-4 text-lg font-bold" dir="rtl">
            نمای کلی
          </h2>
