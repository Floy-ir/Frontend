...
export function MobileTabs({ chatContent, tripContent }: MobileTabsProps) {
  ...
  return (
    <div className="flex h-screen flex-col">
      {/* Tab Content */}
      <div className="flex-1 overflow-hidden">{activeTab === "chat" ? chatContent : tripContent}</div>
      ...
      <div className="flex border-t border-gray-200 bg-white" dir="rtl">
        <button
          ...
          className={`flex flex-1 flex-col items-center gap-1 py-3 transition-colors ${
            activeTab === "chat" ? "text-Primary-P500main" : "text-Gray-N600 hover:bg-gray-50"
          }`}
          aria-label="چت"
        ...
        <button
          ...
          className={`flex flex-1 flex-col items-center gap-1 py-3 transition-colors ${
            activeTab === "trip" ? "text-Primary-P500main" : "text-Gray-N600 hover:bg-gray-50"
          }`}
