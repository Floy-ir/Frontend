...
import { ChevronDown, ChevronLeft, ChevronRight, ChevronUp, Landmark, MoreVertical, X } from "lucide-react"
    ...
    <div className="flex flex-col overflow-hidden rounded-lg border border-gray-200 bg-white" dir="rtl">
      ...
      <div className="flex items-center gap-3 p-3">
        ...
        <div className="flex min-w-0 flex-1 flex-col">
          <h3 className="text-Gray-N800 font-anjoman-max truncate text-base font-semibold">{activity.name}</h3>
