                            ...
                            <div className="relative">
                              {!authUser ? (
                                ...
                                <div className="relative">
                                  ...
                                  {userMenuOpen && (
                                    <div className="absolute left-0 top-full mt-1 w-30 rounded-md  bg-white shadow-lg ">
                                      <button
                                        onClick={() => {
                                          try {
                                        ...
                                        className="w-full px-4 py-2 text-right text-sm hover:bg-Gray-N50 hover:rounded-md"
                                      >
                                        خروج
                                      </button>
                                    </div>
                          ...
                          <div className="flex w-full items-center justify-between lg:hidden">
                            ...
                            {!authUser ? (
                              ...
                              <div className="relative">
                                ...
                                {userMenuOpen && (
                                  <div className="absolute left-0 top-full mt-1 w-30 rounded-md border bg-white shadow-lg">
                                    <button
                                      onClick={() => {
                                        try {
                                          localStorage.removeItem("auth_token")
