...
export function FlightSearchForm({
  ...
  const renderErrorMessage = (errorMessage?: string) => {
    ...
    return (
      <div className="text-Error-E500main text-xs absolute -bottom-5 md:-bottom-2">
        ...
        <div className={`flex w-full flex-col items-start gap-4 lg:flex-row lg:items-center lg:gap-6 ${className}`}>
          ...
          <div className="mt-4 flex w-full flex-col items-start gap-1 px-4 lg:mt-0 lg:flex-row lg:items-center lg:gap-3 xl:gap-6 lg:px-0">
            ...
            <div className="flex w-full flex-col lg:hidden">
              <div className="flex w-full flex-row-reverse items-center gap-4">
                ...
                <div className="flex flex-1 flex-col">
                  ...
                  <div className="z-150 w-full relative mb-5">
                    <Controller
                      name="origin"
                      control={control}
            ...
            <div className="flex w-full flex-row items-center gap-4">
              ...
              <div className="w-1/2 relative mb-5 lg:mb-0 lg:w-20 xl:w-20">
                <Controller
                  name="departureDate"
                  control={control}
                  render={({ field, fieldState }) => (
              ...
              {/* Passengers Field */}
              <div className="w-1/2 relative mb-5 lg:mb-0 lg:w-16 xl:w-18">
                <Controller
                  name="passengers"
                  control={control}
                  render={({ field, fieldState }) => (
