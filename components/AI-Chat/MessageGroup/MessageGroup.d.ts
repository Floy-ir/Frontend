...
export declare const MessageGroupHeader: (
  props: ChatComponentPropsChildren<MessageGroupHeaderProps, "div">
) => ReactElement

export type MessageGroupFooterProps = EmptyProps

export declare const MessageGroupFooter: (
  props: ChatComponentPropsChildren<MessageGroupFooterProps, "div">
) => ReactElement

export type MessageGroupMessagesProps = EmptyProps

export declare const MessageGroupMessages: (
  props: ChatComponentPropsChildren<MessageGroupMessagesProps, "div">
) => ReactElement
