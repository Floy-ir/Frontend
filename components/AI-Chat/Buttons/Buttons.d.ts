...
export declare const AttachmentButton: (
  props: ChatComponentPropsChildren<AttachmentButtonProps, "button">
) => ReactElement
...
export declare const VideoCallButton: (
  props: ChatComponentPropsChildren<VideoCallButtonProps, "button">
) => ReactElement

export type VoiceCallButtonProps = Omit<ButtonProps, "icon">

export declare const VoiceCallButton: (
  props: ChatComponentPropsChildren<VoiceCallButtonProps, "button">
) => ReactElement
