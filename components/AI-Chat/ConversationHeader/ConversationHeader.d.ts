...
declare const ConversationHeaderActions: (
  props: ChatComponentPropsChildren<ConversationHeaderActionsProps, HTMLElement>
) => ReactElement

export type ConversationHeaderBackProps = EmptyProps

declare const ConversationHeaderBack: (
  props: ChatComponentPropsChildren<ConversationHeaderBackProps, "div">
) => ReactElement
...
declare const ConversationHeaderContent: (
  props: ChatComponentPropsChildren<ConversationHeaderContentProps, "div">
) => ReactElement
