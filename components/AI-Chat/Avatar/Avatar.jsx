...
function AvatarInner({ name = "", src = "", size = "md", status, className, active = false, children, ...rest }, ref) {
  ...
  return (
    <div
      ref={avatarRef}
      {...rest}
      className={classNames(`${cName}${sizeClass}`, { [`${cName}--active`]: active }, className)}
    >
      {children ? (
        children
      ) : (
