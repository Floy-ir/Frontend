...
declare const MessageCustomContent: (
  props: ChatComponentPropsChildren<MessageCustomContentProps, "div">
) => ReactElement
...
export { MessageCustomContent, MessageHtmlContent, MessageImageContent, MessageTextContent, Message }
