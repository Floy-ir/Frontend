...
function AccordionItem({
  ...
  return (
    <AccordionPrimitive.Item
      ...
      className={cn("border-b last:border-b-0 border-slate-100", className)}
      {...props}
    />
  )
}
...
function AccordionTrigger({
  ...
  return (
    <AccordionPrimitive.Header className="flex">
      ...
      >
        {children}
        <ChevronDownIcon className=" pointer-events-none size-4 shrink-0 translate-y-0.5 transition-transform duration-200 text-slate-400" />
      </AccordionPrimitive.Trigger>
