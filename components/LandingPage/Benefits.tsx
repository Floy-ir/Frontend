...
export default function Benefits() {
  return (
    <div className="w-full pb-2 md:pb-0 overflow-x-auto md:flex md:items-center md:justify-center">
      <div className="mb-4 mt-8 inline-flex h-[54px] min-w-max shrink-0 snap-x snap-mandatory items-center justify-center gap-18 px-4 md:px-0">
        {/*Title */}
        ...
        {/* Benefits */}
        <div className="flex items-center justify-start gap-3 sm:gap-5 md:gap-8 md:mx-5">
          {/* Benefit 1 */}
          <div className="flex items-center justify-end gap-3 sm:gap-3.5 md:gap-4">
            <div className="relative size-7 sm:size-9 md:size-[39.02px]">
              <div className="size-[21.85px] absolute top-[4.78px] left-[4.78px] bg-Primary-P100 rounded-[20.07px] sm:size-[26px] sm:top-[6px] sm:left-[6px] md:hidden"></div>
              <Image 
                src={flashBg} 
                alt="flash-bg" 
                width={39} 
            ...
            <span className="text-Gray-N700 text-right text-[13px] sm:text-[15px] leading-normal md:text-base md:leading-7 font-medium">
          ...
          {/* Divider */}
          <div className="w-px self-stretch bg-Gray-N200 sm:mx-2 md:mx-4 md:h-12 md:self-auto md:bg-slate-200" />
          ...
          <div className="flex items-center justify-end gap-3 sm:gap-3.5 md:gap-4">
            <div className="relative size-7 sm:size-9 md:size-[39.02px]">
              <Image 
                ...
                width={27} 
                height={27} 
                className="absolute top-[1.37px] left-[2.73px] sm:size-9 sm:top-[2px] sm:left-[3px] md:hidden" 
              />
              <Image 
                src={lampBg} 
                alt="lamp-bg" 
            ...
            <span className="text-Gray-N700 text-right text-[13px] sm:text-[15px] leading-normal md:text-base md:leading-7 font-medium">ارزان‌ترین قیمت</span>
          </div>
          ...
          <div className="flex items-center justify-end gap-3 sm:gap-3.5 md:gap-4">
            ...
            <span className="text-Gray-N700 text-right text-[13px] sm:text-[15px] leading-normal md:text-base md:leading-7 font-medium">بهترین برای مقایسه</span>
          </div>
        </div>
      </div>
    </div>
