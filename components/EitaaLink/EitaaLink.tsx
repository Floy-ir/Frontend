 ...
 */
export const EitaaLink: React.FC<EitaaLinkProps> = ({ href, children, className = "", options }) => {
  ...
  return (
    <a href={href} onClick={isClient ? handleClick : undefined} className={className} suppressHydrationWarning>
      {children}
    </a>
  )
}
